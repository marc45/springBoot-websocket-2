...
public class EventHandler {
	...
	@HandleAfterCreate
	public void newEmployee(Portfolio employee) {
		this.websocket.convertAndSend(
				MESSAGE_PREFIX + "/newEmployee", getPath(employee));
	}

	@HandleAfterDelete
	public void deleteEmployee(Portfolio employee) {
		this.websocket.convertAndSend(
				MESSAGE_PREFIX + "/deleteEmployee", getPath(employee));
	}

	@HandleAfterSave
	public void updateEmployee(Portfolio employee) {
		this.websocket.convertAndSend(
	 ...
	 * @param employee
	 */
	private String getPath(Portfolio employee) {
